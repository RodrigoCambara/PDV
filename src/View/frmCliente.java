...
public class frmCliente extends javax.swing.JFrame {
    ...
    public void listar() {
        ...
        List<clienteClass> lista = dao.listarClientes();
    ...
    private void initComponents() {
        ...
        tabelaClientes.setForeground(new java.awt.Color(0, 0, 102));
        tabelaClientes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id", "Nome", "RG", "CPF", "Email", "Telefone", "Celular", "CEP", "Endereço", "Número", "Complemento", "Bairro", "Cidade", "UF"
            }
        ));
        ...
        jTabbedPane1.addTab("Consulta de clientes", jPConsulta);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        ClientesDAO dao = new ClientesDAO();
        List<clienteClass> lista = dao.buscaClientePorNome(nome);
        DefaultTableModel dados = (DefaultTableModel) tabelaClientes.getModel();
        dados.setNumRows(0);
